...
public class TelaL1 extends JFrame implements ActionListener {
	...
	JButton botaoLClien = new JButton("Entrar como uma loja");

	JButton botaoVolta = new JButton("Voltar");
	ImageIcon imagem = new ImageIcon(
			getClass().getResource("depositphotos_14004028-stock-illustration-seamless-pattern-with-funny-cats.jpg"));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == botaoLAdm) {
			...
			TelaLoginLoja loginLoja = new TelaLoginLoja();
			loginLoja.setResizable(false);
			loginLoja.setLocationRelativeTo(null);
			loginLoja.setVisible(true);
			dispose();
