...
public class TelaPesquisarProdutoAdm extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == botaoVolta) {
			...
			TelaEspacoAdmPesquisar espaco = new TelaEspacoAdmPesquisar();
	...
	@SuppressWarnings({})
	public TelaPesquisarProdutoAdm(final String aux) {
		setAux(aux);
	...
	public static void main(String[] args) {
		new TelaPesquisarProdutoAdm(aux);
	}
	...
	public void setAux(String aux) {
		TelaPesquisarProdutoAdm.aux = aux;
	}
