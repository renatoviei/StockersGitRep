...
public class TelaLoginLoja extends JFrame implements ActionListener {
	...
	ImageIcon imagem = new ImageIcon(getClass().getResource("cara.jpg"));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == botaoEntra) {
			...
			} else if (fachada.efetuarLoginLoja(caixaLogin.getText(), caixaSenha.getText()) instanceof LojaEntity) {
	...
	public TelaLoginLoja() {
		...
		JLabel login = new JLabel("Digite seu email: ");
